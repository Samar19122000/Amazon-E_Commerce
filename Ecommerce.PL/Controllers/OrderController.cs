...
namespace Ecommerce.PL.Controllers
{
    public class OrderController : Controller
    {
        ...
        public OrderController(IGenericRepository<Order> repository, IGenericRepository<OrderProduct> orderProduct, IOrderProductRepo orderProductRepo, IMapper mapper)
        {
        ...
        public async Task<IActionResult> Create(OrderVM order)
        {
            try
            {
                ...
                foreach (var item in order.ProductId)
                {
                    ...
                    await _orderProductRepo.Create(data, item);
                }
